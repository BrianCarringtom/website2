...
if(isset($_GET['txtID'])){
    ...
    $sentencia=$conexion->prepare("SELECT * FROM tbl_configuraciones2 WHERE id=:id ");
...
if($_POST){
    ...
    $sentencia=$conexion->prepare("UPDATE `tbl_configuraciones2` SET nombreconfiguracion=:nombreconfiguracion, valor=:valor  WHERE id=:id ;");
...
<div class="card">
    ...
    <div class="mb-3">
        ...
        <input  readonly value="<?php echo $nombreconfiguracion;?>"
            type="text"
            class="form-control"
