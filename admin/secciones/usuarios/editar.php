...
if(isset($_GET['txtID'])){
    ...
    $sentencia=$conexion->prepare("SELECT * FROM tbl_usuarios2 WHERE id=:id ");
...
if($_POST){
    print_r($_POST);
     ...
     $sentencia=$conexion->prepare("UPDATE tbl_usuarios2 SET usuario=:usuario, correo=:correo, password=:password WHERE id=:id ");
